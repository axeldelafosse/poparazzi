...
function IconSearchActive(props: SvgProps) {
  return (
    <Svg
    ...
    >
      <Defs>
        <ClipPath id="iconSearchActive_svg__a">
          <Path d="M1 1h23v23H1zm0 0" />
        </ClipPath>
        <ClipPath id="iconSearchActive_svg__b">
      ...
      <G clipPath="url(#iconSearchActive_svg__a)">
        <G clipPath="url(#iconSearchActive_svg__b)">
